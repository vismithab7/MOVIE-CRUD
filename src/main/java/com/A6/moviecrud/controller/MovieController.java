...
public class MovieController {
	...
	public String update(@RequestParam long id, ModelMap map) {
	 Optional<Movie> movie1	= repository.findById(id);
	 if(movie1.isPresent())
	 {
		 map.put("movie", movie1.get());
		 return "update.html";
	 }
		return "fetch.html";
	...
	@PostMapping("/update")
	public String edit(Movie movie,ModelMap map) {
		repository.save(movie);
		map.put("message", "movie updated sucessfully");
		return "main.html";
	}
